module.exports={
    ...
    index:{
        ...
        part_7:{
            ...
            province:'Suite No. 8, 36/F Skyline Tower, 39 Wang Kwong Road, Kowloon Bay,Kowloon, Hong Kong.',
            address:'(852) 2573 8313',
            wechat:'(852) 2795 0342',
    ...
    ctpat:{
        ...
        list2:["Increased security throughout your supply chain from offshore manufacturing facilities to your Distribution Centers or your customer's door",'Improved control in the initiatives against theft, pilferage, or other loss to your valuable assets','Greater protection against security breach which could result in your company being an unwilling participant in plots ranging from hijacking to terrorism; while at the same time destroying your public image','Achieve a more effective import program as well as enhanced security awareness within your entire company ']
    },
    media:{
